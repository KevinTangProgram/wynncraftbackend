...
const exceptions = ["Zyreon", "BoostyPoopies", "Awesome_AA", "azarashiouo", "ishinaga", "fudgeawsome", "KiwiOverlord", "ProactiveM815"]
...
app.post('/check', async (req, res) => {
    ...
    try
    {
        ...
        await axios.get("https://api.wynncraft.com/v3/player/" + req.body.username)
        .then((response) => {
